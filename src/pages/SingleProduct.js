...
const SingleProduct = () => {
  ...
  return (
    <>
          ...
          <div className="row">
            <div className="col-6">
              ...
              <div className="other-product-images d-flex flex-wrap gap-15">
                <div>
                  <img
                    src="https://www.bartonwatchbands.com/cdn/shop/articles/Most_popular_luxury_watches.jpg?v=1686944605&width=1100"
                    className="img-fluid"
                    alt=""
                  />
                </div>
            ...
            <div className="col-6">
              <div className="main-product-details">
                <div className="border-bottom">
                  <h3 className="title">Some Product</h3>
                </div>
                ...
                <div className="py-3">
                  ...
                  <div className="d-flex gap-10 align-items-center my-2">
                    ...
                    <p className="product-data">Some Brand</p>
                  </div>
                  <div className="d-flex gap-10 align-items-center my-2">
      ...
      <section className="home-wrapper-2 reviews-wrapper">
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
                ...
                <div className="reviews mt-4">
                  <div className="review">
                    ...
                    <p className="mt-3">
                      ...
                      cum, beatae dignissimos aperiam et id veritatis! Magnam
                      fuga deleniti, dolore eaque architecto consequuntur
                      blanditiis.
                    </p>
                  </div>
                </div>
